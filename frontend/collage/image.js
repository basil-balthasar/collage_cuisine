...
function preload(){
    ...
    for(let f = 0; f<numberOfImages[1]; f++){
        foregroundImages[f] = loadImage("./content/collageElements/FG/"+f+".png")
    }
    for(let o = 0; o<numberOfImages[2]; o++){
        layerOneImages[o] = loadImage("./content/collageElements/ONE/"+o+".png")
    }
    for(let t = 0; t<numberOfImages[3]; t++){
        layerTwoImages[t] = loadImage("./content/collageElements/TWO/"+t+".png")
    }
